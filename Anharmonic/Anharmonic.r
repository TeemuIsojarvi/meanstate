# This program calculates the ground state wave function of an anharmonic 1D oscillator with an unusual method
...
for(j in c(1:nx)) {
V[j] = as.complex(2*(j*dx-3)*(j*dx-3)*(j*dx-3)*(j*dx-3))			
}
